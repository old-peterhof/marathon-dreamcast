...
| Since | Symptom | Notes |
|---|---|---|
| b17 | **"Continue Saved Game" crashes to a black screen** on hardware | Reported 2026-08-15. Not investigated yet. Saved games are not mirrored to VMU, so this is likely reading a saved game that does not exist or is malformed on the ramdisk. |
