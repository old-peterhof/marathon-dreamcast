...
#define LIST_SEP ':'
	...
	// Initialize everything
	dc_trace(6, "start: fonts");
	initialize_fonts();
	dc_trace(6, "start: sound");
	initialize_sound_manager(sound_preferences);
	dc_trace(6, "start: music");
	initialize_marathon_music_handler();
	dc_trace(6, "start: keyboard");
	initialize_keyboard_controller();
	dc_trace(6, "start: screen");
	initialize_screen(&graphics_preferences->screen_mode);
	dc_trace(6, "start: marathon");
	initialize_marathon();
	dc_trace(6, "start: screen_drawing");
