...
#
# A hardware image must not contain AUTOSTART, PADTEST, DEBUG, PROFILE, AUTOKEY or SLOT. Those markers
...
fail=0
for m in AUTOSTART PADTEST DEBUG PROFILE AUTOKEY SLOT; do
